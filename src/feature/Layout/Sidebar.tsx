      ...
      >
         <div className="w-56 max-sm:w-full flex items-center justify-between pt-8 px-2">
            <div className="flex items-center">
               <img src="/money.png" className="w-10 h-10" alt="logo" />
                  <p className="text-xl font-bold mr-3"> مدیریت مالی</p>
         ...
         <div
            ...
            }  px-2 bg-green-900 rounded-3xl cursor-pointer`}
            onClick={() => {
               setOpen(!open);
            }}
         >
                     ...
                     return (
                        <li
                           ...
                           className={`${
                              ...
                              isActive ? 'bg-green-100 flex justify-center' : ''
                           }`}
                           key={index}
                        >
                           <Link
                ...
                ${open ? 'justify-start' : 'justify-center'}
                  `}
                     ...
                     return (
                      ...
                      ${route.isOpen ? 'bg-blue-400 text-green-800' : ''}
                      `}
                              onClick={() => {
                                 handleCategoryClick(index);
                              }}
                           ...
                           >
                              {route?.children?.map(
                                 (child: any, childIndex: number) => {
                                    const isActiveChild = pathname.startsWith(
                                       child.path
                                    );
                                    return (
                                       <li key={childIndex}>
