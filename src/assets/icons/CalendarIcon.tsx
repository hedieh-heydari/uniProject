...
const CalendarIcon: React.FC<iconInterface> = ({ className }) => {
   return (
      <>
         ...
         >
            <path
               d="M3.09351 9.82788H20.9175"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M16.4431 13.7333H16.4524"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M12.0056 13.7333H12.0149"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M7.55884 13.7333H7.5681"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M16.4431 17.6198H16.4524"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M12.0056 17.6198H12.0149"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M7.55884 17.6198H7.5681"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M16.0447 2.42358V5.71436"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
               d="M7.96655 2.42358V5.71436"
               strokeLinecap="round"
               strokeLinejoin="round"
            />
            <path
